          ...
          <div className="projects row">
            {
              projects.map((project,i)=>(
                <div className="project-item col-4" key={i}  onClick={() => handleClick(i)} >
                  <div className="project-item-bg" style={{ backgroundImage: `url(${project.thumUrl})` }}></div>
                  <h3>{project.title}</h3>
                </div>
              ))
            }
          ...
          <div className="overlay" id={`detail-${i}`} key={i}>
            <div className="detail row">
              <div className="detail-bg col-6">
                 ...
                 <div className="detail-bg-img" style={{ backgroundImage: `url(${project.thumUrl})` }}></div>
              ...
              <div className="detail-desc col-6">
                <div className="detail-desc-title">
                 ...
                 <div className="detail-desc-info">
                  ...
                  <p>Demo: <a href={project.demo}>{project.demo}</a></p>
                  <p>GitHub: <a href={project.git}>{project.git}</a></p>
                 </div>
              </div>
